...
class Student {
    ...
    constructor(name: string, fatherName: string, age: number, gender: string , contactNumber : number) {
...
class Student_Manager {
    ...
    addStudent(name: string, fatherName: string, age: number, gender: string, contactNumber: number ) {
